...
- `'beforeConsuming'` — runs before the handler. Reject unauthorised messages, set up logging context, time the handler.
...
- Runnable example: [`examples/filters/`](https://github.com/twatson83/ServiceConnect-NodeJS/tree/v3/examples/filters)
