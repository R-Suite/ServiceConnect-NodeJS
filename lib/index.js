...
var Bus = exports.Bus = function (_EventEmitter) {
  ...
  _createClass(Bus, [{
    ...
    key: '_consumeMessage',
    value: function () {
      var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(message, headers, type) {
        var process;
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                _context5.prev = 0;
                _context5.next = 3;
                return this._processFilters(this.config.filters.before, message, headers, type);
              ...
              case 6:
                _context5.next = 8;
                return Promise.all([].concat(_toConsumableArray(this._processHandlers(message, headers, type)), [this._processRequestReplies(message, headers, type)]));

              case 8:
                _context5.next = 10;
                return this._processFilters(this.config.filters.after, message, headers, type);
      ...
      function _consumeMessage(_x19, _x20, _x21) {
        return _ref5.apply(this, arguments);
      }

      return _consumeMessage;
    }()
  }, {
    key: '_processFilters',
    value: function () {
      var _ref6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(filters, message, headers, type) {
        var i, result;
      ...
      function _processFilters(_x22, _x23, _x24, _x25) {
