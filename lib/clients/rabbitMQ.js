    ...
    _createClass(Client, [{
        ...
        value: function send(endpoint, type, message) {
            ...
            return Promise.all(endpoints.map(function (ep) {
                ...
                return _this5.channel.sendToQueue(ep, message, { headers: messageHeaders, messageId: messageHeaders.MessageId });
            }));
        }
        ...
        value: function publish(type, message) {
            ...
            return this.channel.addSetup(function (channel) {
                ...
                return _this6.channel.publish(type.replace(/\./g, ""), '', message, { headers: messageHeaders, messageId: messageHeaders.MessageId });
            });
        }
        ...
        value: function () {
            var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(rawMessage) {
                var result, headers, _message, retryCount;
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                ...
                                _message = JSON.parse(rawMessage.content.toString());
                                _context.prev = 6;
                                _context.next = 9;
                                return this.consumeMessageCallback(_message, headers, headers.TypeName);
                            ...
                            case 21:
                                ...
                                if (result !== null) {
                                    ...
                                    if (retryCount < this.config.amqpSettings.maxRetries) {
                                        ...
                                        this.channel.sendToQueue(this.config.amqpSettings.errorQueue, message, {
                                            headers: headers,
                                            messageId: rawMessage.properties.messageId
                                        });
                                    }
