            ...
            try {
                ...
                yield new Promise((resolve, reject) => {
                    ...
                    try {
                        ...
                        this.channel = (_b = this.connection) === null || _b === void 0 ? void 0 : _b.createChannel({
                            json: true,
                            setup: (channel) => __awaiter(this, void 0, void 0, function* () {
                                var _c;
                                yield channel.prefetch(this.config.amqpSettings.prefetch);
                                (_c = this.config.logger) === null || _c === void 0 ? void 0 : _c.info("RabbitMQ channel created.");
    ...
    _createQueues(channel) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                (_d = this.config.logger) === null || _d === void 0 ? void 0 : _d.info(`Configuring Error queue.`);
                ...
                if (this.config.amqpSettings.auditEnabled) {
                    (_e = this.config.logger) === null || _e === void 0 ? void 0 : _e.info(`Configuring audit queue.`);
                ...
                (_f = this.config.logger) === null || _f === void 0 ? void 0 : _f.info(`Binding consume message callback to queue.`);
                yield channel.consume(this.config.amqpSettings.queue.name, this._consumeMessage, {
                    noAck: this.config.amqpSettings.queue.noAck
                });
            }
            catch (error) {
                (_g = this.config.logger) === null || _g === void 0 ? void 0 : _g.error("Error configuring rabbitmq message bus", error);
                throw error;
            }
        });
    }
    ...
    _consumeMessage(rawMessage) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                (_a = this.config.logger) === null || _a === void 0 ? void 0 : _a.error("Error processing message", error);
            }
            finally {
                if (!this.config.amqpSettings.queue.noAck) {
                    (_b = this.channel) === null || _b === void 0 ? void 0 : _b.ack(rawMessage);
                }
                this.processing--;
            }
        });
