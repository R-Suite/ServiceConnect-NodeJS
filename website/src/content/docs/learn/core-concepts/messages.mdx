...
- **Registration order does not matter** for parents — declare children first or last; the registry stores the parent list verbatim and the transport applies it (binding parent exchanges) when messages are published.
