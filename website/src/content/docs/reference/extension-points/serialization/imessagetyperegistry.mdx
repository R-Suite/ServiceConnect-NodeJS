...
`createMessageTypeRegistry()` returns the default in-memory implementation. It's a tiny `Map`-backed object; you should reach for it unless you have a specific reason to ship your own.
