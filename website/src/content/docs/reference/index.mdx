...
Reference pages are hand-written: no auto-generation. If a primary type appears in the public surface and you can't find it here, please [open an issue](https://github.com/R-Suite/ServiceConnect-NodeJS/issues).
