...
var Client = function (_EventEmitter) {
  ...
  _createClass(Client, [{
    ...
    value: function connect() {
      ...
      this.connection = _amqpConnectionManager2.default.connect(hosts, { connectionOptions: options });
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 3;
                return this.channel._channel.cancel(Object.keys(this.channel._channel.consumers)[0]);
