...
- **`logger`** — a child [`Logger`](/ServiceConnect-NodeJS/reference/bus/bus-options/) with `messageType`, `messageId`, and `correlationId` bound; every log line emitted through it inherits those fields.
